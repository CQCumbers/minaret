...
module mfi_inst_flsr (
  ...
  // FLSR instruction
  wire [31:0] result = {mfi_src1_rdata, mfi_src2_rdata} >> mfi_src3_rdata[4:0];
  assign spec_valid = mfi_valid && !inst_padding && inst_opcode == 8'b 01101101;
