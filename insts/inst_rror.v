...
module mfi_inst_rror (
  ...
  // RROR instruction
  wire [31:0] result = {mfi_src1_rdata, mfi_src1_rdata} >> mfi_src2_rdata[4:0];
  assign spec_valid = mfi_valid && !inst_padding && inst_opcode == 8'b 01101011;
