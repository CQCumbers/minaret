...
module mfi_inst_mt (
  ...
  // MT instruction
  wire cond = mfi_mcr_rdata[18] == 1;
  assign spec_valid = mfi_valid && !inst_padding && inst_opcode == 8'b 01011001;
  assign spec_src1_addr = inst_src1;
  assign spec_dest_addr = cond ? inst_dest : 0;
  assign spec_dest_wdata = cond ? mfi_src1_rdata : 0;
