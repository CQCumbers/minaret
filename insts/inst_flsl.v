...
module mfi_inst_flsl (
  ...
  // funnel shift instruction format
  ...
  wire [3:0] inst_rshift = mfi_inst[11: 8];

  // FLSL instruction
  wire [31:0] result = ({mfi_src1_rdata, mfi_src2_rdata} << mfi_src3_rdata[4:0]) >> 32;
  assign spec_valid = mfi_valid && !inst_padding && inst_opcode == 8'b 01101100;
  assign spec_src1_addr = inst_src1;
  assign spec_src2_addr = inst_src2;
  assign spec_src3_addr = inst_rshift;
