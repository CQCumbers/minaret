...
module mfi_inst_movu (
  ...
  wire [15:0] inst_imm   = {mfi_inst[19:16], mfi_inst[11:0]};

  // MOVU instruction
  assign spec_valid = mfi_valid && !inst_padding && inst_opcode == 8'b 01010100;
  assign spec_dest_addr = inst_dest;
  assign spec_dest_wdata = inst_imm << 16;
