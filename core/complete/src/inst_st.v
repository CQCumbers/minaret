...
module mfi_inst_st (
  ...
  // ST instruction
  wire [31:0] addr = mfi_src1_rdata + inst_imms;
  assign spec_valid = mfi_valid && !inst_padding && inst_opcode == 8'b 01000011;
  ...
  assign spec_mem_wdata = mfi_src2_rdata << (8*(addr-spec_mem_addr));
